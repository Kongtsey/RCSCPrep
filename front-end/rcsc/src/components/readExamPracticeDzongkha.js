...
import question_1_image from "../images/exam-broken-images/dzongkha_exam_on_sign_up_question_1.png";
...
class ReadDzongkhaSignUpExamQuestion extends Component {
  ...
  handleChange = (questionId, userChoice, correctAnswer, index) => () => {
    ...
    userCollection.doc("ExamOnSignUp").collection("Dzongkha").doc(questionId).set(
      {
        UserAnswer: index,
      },
      { merge: true }
