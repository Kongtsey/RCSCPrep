            ...
            <Col className='info_description' md={6} lg={6} sm={12}>
              <ScrollAnimation animateIn='fadeInRight' animateOnce={true}>
                ...
                <p className='info_description_content'>
                  ...
                  <br />
                  You can also choose to focus on what you lack rather than just going along with the classroom, in a sense RCSC Prep is what allows you to make this education a 21st century education
